...
const AddOrder = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const existingOrderCheck = await axios.get("https://queue-backendser.onrender.com/check-duplicate", {
    ...
    current_status: "Waiting" // ✅ Set a default status
        ...
        try {
            const response = await axios.post("https://queue-backendser.onrender.com/orders", newOrder);
